...
\label{classeu_1_1basicairdata_1_1bluetoothhelper_1_1BluetoothHelper}\index{Bluetooth\+Helper@{Bluetooth\+Helper}}
...
\begin{DoxyCompactList}\small\item\em Adds the specified \doxyref{Bluetooth\+Helper}{p.}{classeu_1_1basicairdata_1_1bluetoothhelper_1_1BluetoothHelper} listener to receive events from this class. \end{DoxyCompactList}\item 
...
void \textbf{ Connect} (Bluetooth\+Device bluetooth\+Device)
\begin{DoxyCompactList}\small\item\em Connects to the remote Bluetooth\+Device (server). \end{DoxyCompactList}\item 
...
This Java Class implements an easy message-\/based Bluetooth wireless communication layer between an {\bfseries Android device} (the client) and a {\bfseries Microcontroller} (the server).
...
\mbox{\label{classeu_1_1basicairdata_1_1bluetoothhelper_1_1BluetoothHelper_af28fe6832f4dd3f13033e5c666525f07}} 
\index{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper@{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper}!Clear\+Buffer@{Clear\+Buffer}}
\index{Clear\+Buffer@{Clear\+Buffer}!eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper@{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper}}
...
It clears the input\+Message\+Queue and then the output\+Message\+Queue, used by separate threads to perform communication.~\newline
 ...
 The method is public in case of particular user needs. \mbox{\label{classeu_1_1basicairdata_1_1bluetoothhelper_1_1BluetoothHelper_a8239955fadff0358c4506e232cf5cb7d}} 
\index{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper@{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper}!Connect@{Connect}}
\index{Connect@{Connect}!eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper@{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper}}
\subsubsection{Connect()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
It bootstraps the connection to the paired (bonded) device named “\+Device\+Name” if exists.~\newline
 The function does return immediately, when the connection process is yet in progress, with no result.~\newline
 You can receive a notification when the connection process is completed attaching a \doxyref{Bluetooth\+Helper\+Listener}{p.}{interfaceeu_1_1basicairdata_1_1bluetoothhelper_1_1BluetoothHelper_1_1BluetoothHelperListener}. As an alternative you can check the connection status with the \doxyref{is\+Connected()}{p.}{classeu_1_1basicairdata_1_1bluetoothhelper_1_1BluetoothHelper_afbf4768f0408a85337dbb9f1413d611a} method described below.~\newline
...
\end{DoxySeeAlso}
\mbox{\label{classeu_1_1basicairdata_1_1bluetoothhelper_1_1BluetoothHelper_a3d98aad14e680ea9978e0dd82c2571b2}} 
\index{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper@{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper}!Connect@{Connect}}
\index{Connect@{Connect}!eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper@{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper}}
\subsubsection{Connect()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily void Connect (\begin{DoxyParamCaption}\item[{Bluetooth\+Device}]{bluetooth\+Device }\end{DoxyParamCaption})}



Connects to the remote Bluetooth\+Device (server). 

It bootstraps the connection to the paired (bonded) device Bluetooth\+Device if exists.~\newline
 The function does return immediately, when the connection process is yet in progress, with no result.~\newline
 You can receive a notification when the connection process is completed attaching a \doxyref{Bluetooth\+Helper\+Listener}{p.}{interfaceeu_1_1basicairdata_1_1bluetoothhelper_1_1BluetoothHelper_1_1BluetoothHelperListener}. As an alternative you can check the connection status with the \doxyref{is\+Connected()}{p.}{classeu_1_1basicairdata_1_1bluetoothhelper_1_1BluetoothHelper_afbf4768f0408a85337dbb9f1413d611a} method described below.~\newline
 An on\+Bluetooth\+Helper\+Connection\+State\+Changed event occurs (if listener is attached) when the connection process terminates, returning the new status of the connection. In case of success, the class will be ready to communicate with the remote device. 
\begin{DoxyParams}{Parameters}
{\em bluetooth\+Device} & The remote Bluetooth\+Device \\
\hline
\end{DoxyParams}
\begin{DoxySeeAlso}{See also}
Bluetooth\+Adapter 
...
Bluetooth\+Device 
\end{DoxySeeAlso}
\mbox{\label{classeu_1_1basicairdata_1_1bluetoothhelper_1_1BluetoothHelper_a65d18fa17ec0238d7e72f6c8f5c880b6}} 
\index{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper@{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper}!Disconnect@{Disconnect}}
\index{Disconnect@{Disconnect}!eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper@{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper}}
...
The method closes the Streams, the Socket and terminates all the threads that manage the connection and the communication.~\newline
 An on\+Bluetooth\+Helper\+Connection\+State\+Changed event occurs (if listener is attached) when the disconnection process terminates, returning the new status of the connection. \mbox{\label{classeu_1_1basicairdata_1_1bluetoothhelper_1_1BluetoothHelper_a9ec368da03f0bc7aed0855b47a2a874c}} 
\index{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper@{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper}!Disconnect@{Disconnect}}
\index{Disconnect@{Disconnect}!eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper@{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper}}
...
\hline
\end{DoxyParams}
\mbox{\label{classeu_1_1basicairdata_1_1bluetoothhelper_1_1BluetoothHelper_afbf4768f0408a85337dbb9f1413d611a}} 
\index{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper@{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper}!is\+Connected@{is\+Connected}}
\index{is\+Connected@{is\+Connected}!eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper@{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper}}
...
\end{DoxyReturn}
\mbox{\label{classeu_1_1basicairdata_1_1bluetoothhelper_1_1BluetoothHelper_adf4de53406c02fd549f4bafbb51812af}} 
\index{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper@{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper}!Receive\+Message@{Receive\+Message}}
\index{Receive\+Message@{Receive\+Message}!eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper@{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper}}
...
\doxyref{set\+Bluetooth\+Helper\+Listener()}{p.}{classeu_1_1basicairdata_1_1bluetoothhelper_1_1BluetoothHelper_afbd01dc45b93929de03c394d3f4b913f} 
\end{DoxySeeAlso}
\begin{DoxyReturn}{Returns}
The String containing the message. An empty string otherwise 
\end{DoxyReturn}
\mbox{\label{classeu_1_1basicairdata_1_1bluetoothhelper_1_1BluetoothHelper_ad7aa3bf3849b24ae3e088ce9e445ad8d}} 
\index{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper@{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper}!Send\+Message@{Send\+Message}}
\index{Send\+Message@{Send\+Message}!eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper@{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper}}
...
\end{DoxyReturn}
\mbox{\label{classeu_1_1basicairdata_1_1bluetoothhelper_1_1BluetoothHelper_afbd01dc45b93929de03c394d3f4b913f}} 
\index{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper@{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper}!set\+Bluetooth\+Helper\+Listener@{set\+Bluetooth\+Helper\+Listener}}
\index{set\+Bluetooth\+Helper\+Listener@{set\+Bluetooth\+Helper\+Listener}!eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper@{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper}}
...
Adds the specified \doxyref{Bluetooth\+Helper}{p.}{classeu_1_1basicairdata_1_1bluetoothhelper_1_1BluetoothHelper} listener to receive events from this class. 
...
\begin{DoxyParams}{Parameters}
{\em listener} & The \doxyref{Bluetooth\+Helper\+Listener}{p.}{interfaceeu_1_1basicairdata_1_1bluetoothhelper_1_1BluetoothHelper_1_1BluetoothHelperListener} \\
\hline
\end{DoxyParams}


\subsection{Member Data Documentation}
\mbox{\label{classeu_1_1basicairdata_1_1bluetoothhelper_1_1BluetoothHelper_ad68e2886d9320e3eed8dcfca3cd158ce}} 
\index{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper@{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper}!Delimiter@{Delimiter}}
\index{Delimiter@{Delimiter}!eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper@{eu\+::basicairdata\+::bluetoothhelper\+::\+Bluetooth\+Helper}}
